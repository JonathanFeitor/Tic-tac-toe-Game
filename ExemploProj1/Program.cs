...
namespace ExempleProj1
{
    class Program
    {
        ...
        /// <summary>
        /// Checks with the game was won, tied, or should continue
        /// </summary>
        /// <returns></returns>
        static int CheckWin()
        {
        ...
        static void Main(string[] args)
        {
            do
            {
                ...
                {
                    Console.WriteLine("Sorry the row{0} is alread marked with {1}\n", choise, spaces[choise]);
